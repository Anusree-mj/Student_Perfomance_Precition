...
if st.button("Predict Final Result"):
    ...
    features[0, 30] = g1_score
    features[0, 31] = g2_score
    features[0, 13] = study_time
    features[0, 14] = past_failures
    features[0, 29] = (100 - attendance_pct) * 0.93
    features[0, 21] = 1 if internet == "Yes" else 0
